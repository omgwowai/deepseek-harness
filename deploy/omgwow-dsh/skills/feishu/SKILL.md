...
- 群消息推送：`${DSH_SKILLS_DIR:-/Users/lbc/Documents/dsh-v2/dsh-home/skills}/feishu/scripts/feishu-notify.py`（群机器人 webhook 由使用者自行注册，配置在 `/Users/lbc/Documents/dsh-credentials/feishu-webhook.conf`）

```bash
LARK=$HOME/Documents/harness-rc8/tooling/lark-cli/node_modules/.bin/lark-cli
NOTIFY="/usr/bin/python3 ${DSH_SKILLS_DIR:-/Users/lbc/Documents/dsh-v2/dsh-home/skills}/feishu/scripts/feishu-notify.py"
```
...
- 日报机器人：由运维主机 cron 定时生成仓库日报并推送到同一日报群（本 Skill 的 webhook 即该群），随后用远端 lark-cli 归档知识库。主机名与脚本路径按实际部署填写。
