...
flowchart LR
  ...
  plugin_dsh_base_tokenrouter_rollout["tokenrouter-rollout<br/>@deepseek-ai/dsh-tokenrouter-rollout"]
  cfg --> plugin_dsh_base_tokenrouter_rollout
...
| `tokenrouter-rollout` | `@deepseek-ai/dsh-tokenrouter-rollout` |
